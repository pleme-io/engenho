...
impl ClusterConfig {
    ...
    pub fn render_k3s_config_yaml(&self) -> String {
        ...
        let cluster_cidr = if net.ipv6.dual_stack {
            format!("{},{}", net.cluster_cidr, net.ipv6.cluster_cidr_v6.as_deref().unwrap_or(""))
        } else {
            net.cluster_cidr.clone()
        };
        let service_cidr = if net.ipv6.dual_stack {
            format!("{},{}", net.service_cidr, net.ipv6.service_cidr_v6.as_deref().unwrap_or(""))
        } else {
            net.service_cidr.clone()
        };
