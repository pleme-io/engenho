...
fn kind_doc(description: &str, api_version: &str, kind: &str) -> String {
    if description.is_empty() {
        return format!("/// `{api_version}/{kind}` typed kind — generated by engenho-kube-codegen.");
    }
...
pub fn emit_kind_typed(
    ...
    let fields = emit_fields(entry.openapi_key, &kind_view.properties, &kind_view.required, &mut refs);
...
/// imports.
#[must_use]
pub fn emit_shared_module(shared: &[(String, String, SchemaView)], catalog: &[KindEntry]) -> String {
