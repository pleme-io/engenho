...
pub use supervisor::{
    ...
    Inspection, ReconfigureError, Reconfigured, ResolvedConfig, RestartChildError, RuntimeFacts,
    Snapshot, StopDone, StoreLock, Supervisor, SupervisorConfig, SupervisorError, SupervisorHandle,
    file_digest,
};
