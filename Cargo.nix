...
rec {
  ...
  workspaceMembers = {
    ...
    "engenho-fonte-cli" = rec {
      packageId = "engenho-fonte-cli";
      build = internal.buildRustCrateWithFeatures {
        packageId = "engenho-fonte-cli";
      };
    ...
    "engenho-kube-codegen" = rec {
      packageId = "engenho-kube-codegen";
      build = internal.buildRustCrateWithFeatures {
        packageId = "engenho-kube-codegen";
      };
    ...
    "engenho-machines" = rec {
      packageId = "engenho-machines";
      build = internal.buildRustCrateWithFeatures {
        packageId = "engenho-machines";
      };
    ...
    "engenho-substrate-props" = rec {
      packageId = "engenho-substrate-props";
      build = internal.buildRustCrateWithFeatures {
        packageId = "engenho-substrate-props";
      };
    ...
    "engenho-sui-typescape" = rec {
      packageId = "engenho-sui-typescape";
      build = internal.buildRustCrateWithFeatures {
        packageId = "engenho-sui-typescape";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "caixa-core" = rec {
        crateName = "caixa-core";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../caixa/caixa-core; };
        libName = "caixa_core";
        authors = [
          "pleme-io"
        ];
      ...
      "caixa-helm" = rec {
        crateName = "caixa-helm";
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../caixa/caixa-helm; };
        libName = "caixa_helm";
        authors = [
          "pleme-io"
        ];
      ...
      "chitchat" = rec {
        ...
        version = "0.10.1";
        edition = "2024";
        sha256 = "038h6p8k8l54fgmbkg5vzdziiby9nrcr73siy2z7vxi1gdsr4p72";
        authors = [
        ...
        dependencies = [
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "net" "sync" "rt-multi-thread" "macros" "time" ];
          }
          {
            name = "tokio-stream";
        ...
        devDependencies = [
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "net" "sync" "rt-multi-thread" "macros" "test-util" "time" ];
          }
        ];
        features = {
        };
      ...
      "cofre-types" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "1c39975891795a1e873f4ec3ab68ecbca7cd915a";
          sha256 = "19ay93nkmnrpr3phv83pa862nlf3dlxkma88cg1a34d2jxz3xqzv";
        };
        libName = "cofre_types";
        authors = [
          "pleme-io"
      ...
      "const-hex" = rec {
        ...
        version = "1.19.0";
        edition = "2021";
        sha256 = "1q0l2pm2hnnnkb307zxbvzbdwvnb6cmkhls1z7hcrab7s5isbn90";
        libName = "const_hex";
        authors = [
      ...
      "derive_more 2.1.1" = rec {
        ...
        dependencies = [
          {
            name = "derive_more-impl";
            packageId = "derive_more-impl 2.1.1";
          }
        ];
        features = {
          "add" = [ "derive_more-impl/add" ];
      ...
      "ed25519-dalek" = rec {
        ...
        resolvedDefaultFeatures = [ "alloc" "default" "digest" "fast" "rand_core" "serde" "signature" "std" "zeroize" ];
      };
      "either" = rec {
        crateName = "either";
        version = "1.16.0";
      ...
      "engenho" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./engenho; };
        authors = [
          "pleme-io"
        ];
        dependencies = [
      ...
      "engenho-fonte" = rec {
        crateName = "engenho-fonte";
        version = "0.1.4";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./engenho-fonte; };
        libName = "engenho_fonte";
        authors = [
          "pleme-io"
        ];
        dependencies = [
          ...
          {
            name = "caixa-helm";
            packageId = "caixa-helm";
            optional = true;
          }
          {
            name = "engenho-kube-client";
            packageId = "engenho-kube-client";
            optional = true;
          }
          {
            name = "engenho-revoada";
            packageId = "engenho-revoada";
            optional = true;
          }
          {
          ...
          {
            name = "shikumi";
            packageId = "path+file:///Users/luis.d/code/github/pleme-io/shikumi#0.1.0";
            optional = true;
          }
          {
            name = "promessa-types";
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "full" "sync" "macros" "rt" "time" ];
          }
        ];
        devDependencies = [
          {
            name = "engenho-substrate-props";
            packageId = "engenho-substrate-props";
          }
          {
            name = "proptest";
          ...
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "full" "sync" "macros" "rt" "rt-multi-thread" "time" ];
          }
        ];
        features = {
        ...
        resolvedDefaultFeatures = [ "default" "with-caixa" "with-engenho-kube-client" "with-promessa" "with-revoada" "with-shigoto" "with-shikumi" "with-sui-eval" "with-tameshi" "with-tatara-lisp" ];
      };
      "engenho-fonte-cli" = rec {
        crateName = "engenho-fonte-cli";
        version = "0.1.4";
        edition = "2024";
        crateBin = [
          {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./engenho-fonte-cli; };
        authors = [
          "pleme-io"
        ];
        dependencies = [
          ...
          }
          {
            name = "engenho-fonte";
            packageId = "engenho-fonte";
            features = [ "with-shikumi" "with-sui-eval" "with-revoada" ];
          }
          {
            name = "engenho-revoada";
            packageId = "engenho-revoada";
          }
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "full" "sync" "macros" "rt" "rt-multi-thread" "time" "signal" ];
          }
          {
            name = "tracing";
            packageId = "tracing";
      ...
      "engenho-kube-codegen" = rec {
        ...
        crateBin = [
          {
            name = "engenho-kube-codegen";
            path = "src/bin/codegen.rs";
            requiredFeatures = [ ];
          }
        ];
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./engenho-kube-codegen; };
        libName = "engenho_kube_codegen";
        authors = [
          "pleme-io"
        ];
        dependencies = [
      ...
      "engenho-machines" = rec {
        crateName = "engenho-machines";
        version = "0.1.4";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./engenho-machines; };
        libName = "engenho_machines";
        authors = [
          "pleme-io"
        ];
        dependencies = [
      ...
      "engenho-mcp" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./engenho-mcp; };
        libName = "engenho_mcp";
        authors = [
          "pleme-io"
        ];
        ...
        devDependencies = [
          {
            name = "tokio";
            packageId = "tokio";
            features = [ "full" "sync" "macros" "rt" "rt-multi-thread" ];
          }
        ];

      };
      "engenho-substrate-props" = rec {
        crateName = "engenho-substrate-props";
        version = "0.1.4";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./engenho-substrate-props; };
        libName = "engenho_substrate_props";
        authors = [
          "pleme-io"
        ];
        dependencies = [
      ...
      "engenho-sui-typescape" = rec {
        crateName = "engenho-sui-typescape";
        version = "0.1.4";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./engenho-sui-typescape; };
        libName = "engenho_sui_typescape";
        authors = [
          "pleme-io"
        ];
        dependencies = [
        ...
        features = {
          "with-sui-eval" = [ "dep:sui-eval" ];
        };
        resolvedDefaultFeatures = [ "default" "with-sui-eval" ];
      };
      "engenho-teia" = rec {
      ...
      "engenho-types" = rec {
        ...
        resolvedDefaultFeatures = [ "bit-repro" "default" "openapi-roundtrip" ];
      };
      "equivalent" = rec {
      ...
      "git+https://github.com/pleme-io/shikumi#0.1.0" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "48c7c6d7b9755c9a2b769b53ddc95800aba98b7f";
          sha256 = "1959r1drjhjs55hzd6mc0xgwyvg593j25bg8f6pw0ap36161rvd1";
        };
        dependencies = [
          {
            name = "arc-swap";
      ...
      "object_store" = rec {
        ...
        resolvedDefaultFeatures = [ "aws" "base64" "cloud" "default" "form_urlencoded" "fs" "http-body-util" "hyper" "md-5" "quick-xml" "rand" "reqwest" "ring" "serde" "serde_json" "serde_urlencoded" "tokio" "walkdir" ];
      };
      "once_cell" = rec {
        crateName = "once_cell";
        version = "1.21.4";
      ...
      "path+file:///Users/luis.d/code/github/pleme-io/shikumi#0.1.0" = rec {
        crateName = "shikumi";
        version = "0.1.0";
        edition = "2024";
      ...
      "promessa-types" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../promessa/promessa-types; };
      ...
      "rs_merkle" = rec {
        ...
        version = "1.5.0";
        edition = "2018";
        sha256 = "089b5m2cw6d51fp31d8q3w9aipl753z5vdz7fv3fh8ms629b82dv";
        authors = [
      ...
      "shigoto-budget" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../shigoto/shigoto-budget; };
      ...
      "shigoto-dag" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../shigoto/shigoto-dag; };
        libName = "shigoto_dag";
        authors = [
          "pleme-io"
        ];
      ...
      "shigoto-retry" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../shigoto/shigoto-retry; };
      ...
      "shigoto-types" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../shigoto/shigoto-types; };
      ...
      "sui-bytecode" = rec {
        ...
        version = "0.1.10";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../sui/sui-bytecode; };
      ...
      "sui-compat" = rec {
        ...
        version = "0.1.10";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../sui/sui-compat; };
        libName = "sui_compat";
        dependencies = [
          {
            name = "base64";
      ...
      "sui-eval" = rec {
        ...
        version = "0.1.10";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../sui/sui-eval; };
        libName = "sui_eval";
        dependencies = [
          {
            name = "base64";
      ...
      "sui-intern" = rec {
        ...
        version = "0.1.10";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../sui/sui-intern; };
        libName = "sui_intern";
        dependencies = [
          {
            name = "rustc-hash";
      ...
      "sui-spec" = rec {
        ...
        edition = "2024";
        crateBin = [];
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../sui/sui-spec; };
        libName = "sui_spec";
        dependencies = [
          {
            name = "base64";
          ...
          {
            name = "tatara-lisp";
            packageId = "tatara-lisp 0.2.1";
          }
          {
            name = "tatara-lisp-derive";
            packageId = "tatara-lisp-derive 0.2.1";
          }
          {
            name = "thiserror";
            packageId = "thiserror 2.0.18";
      ...
      "sui-store" = rec {
        ...
        version = "0.1.10";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../sui/sui-store; };
        libName = "sui_store";
        dependencies = [
          {
            name = "async-trait";
      ...
      "tameshi" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ../tameshi; };
        authors = [
